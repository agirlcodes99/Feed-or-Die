...
class Player(pygame.sprite.Sprite):
  ...
  def update(self):
    ...
    self.collide_blcoks('x')
    self.rect.y += self.y_change
    self.collide_blcoks('y')
  ...
  def movement(self):
    ...
    if keys[pygame.K_a]:
      self.x_change -= PLAYER_SPD
      self.facing = 'left'
    if keys[pygame.K_d]:
      self.x_change += PLAYER_SPD
      self.facing = 'right'
    if keys[pygame.K_w]:
      self.y_change -= PLAYER_SPD
      self.facing = 'up'
    if keys[pygame.K_s]:
      self.y_change += PLAYER_SPD
      self.facing = 'down'

  def collide_blcoks(self, direction):
    if direction == 'x':
  ...
  def animate(self):
    ...
    if self.facing == 'down':
      if self.y_change == 0:
        ...
        self.image = down_animations[math.floor(self.anim_loop)]
        self.anim_loop += 0.1
        if self.anim_loop >= 3:
          self.anim_loop = 1
    ...
    if self.facing == 'up':
      if self.y_change == 0:
        ...
        self.image = up_animations[math.floor(self.anim_loop)]
        self.anim_loop += 0.1
        if self.anim_loop >= 3:
          self.anim_loop = 1
    ...
    if self.facing == 'left':
      if self.x_change == 0:
        ...
        self.image = left_animations[math.floor(self.anim_loop)]
        self.anim_loop += 0.1
        if self.anim_loop >= 3:
          self.anim_loop = 1
    ...
    if self.facing == 'right':
      if self.x_change == 0:
        ...
        self.image = right_animations[math.floor(self.anim_loop)]
        self.anim_loop += 0.1
        if self.anim_loop >= 3:
          self.anim_loop = 1
